...
| **Vitest** | API integration tests (D1 + Workers runtime) | `pnpm --filter api test:integration` | 60 tests: smoke (3), recovery (2), auth (3), systems CRUD (16), calendar (24), schedules (12) |
